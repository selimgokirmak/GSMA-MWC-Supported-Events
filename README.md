...
Simple web scraper for extracting exhibitor data from trade show exhibitor lists provided by **GSMA MWC**. 
...
- This scraper is designed to extract data from exhibitor directories with the same HTML structure as the supported GSMA MWC exhibitor lists below.
...
- [MWC Barcelona 2026 Exhibitor List – mwcbarcelona.com](https://mwcbarcelona.com/exhibitors)

- [4FYN Barcelona 2026 Exhibitor List – 4yfn.com](https://4yfn.com/exhibitors)
